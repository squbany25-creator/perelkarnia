...
const PRODUCTS = [
  ...
  {
    id: 2,
    name: "The North Face Kurtka Puchowa M",
    brand: "The North Face",
    category: "kurtki",
    size: "M",
    style: ["gorpcore", "outdoor"],
    price: 99,
    salePrice: 139,
    condition: "Bardzo dobry",
    tags: ["tnf", "kurtka", "zimowa"],
    badge: "hot",
    sold: false,
    description: "Legendarny puchówka The North Face. Ciepła, lekka, z charakterystycznym logo. Idealna na zimę i wiosenne chłodne dni.",
    images: [
  ...
  {
    id: 3,
    name: "Ralph Lauren Sweter Vintage XL",
    brand: "Ralph Lauren",
    category: "inne",
    size: "XL",
    ...
    salePrice: null,
    condition: "Dobry",
    tags: ["ralph lauren", "vintage", "sweter"],
    badge: null,
    sold: false,
    description: "Sweter Ralph Lauren z klasycznym haftowanym kucykiem. Miękka wełna z domieszką bawełny, luźny krój.",
    images: [
      "https://images.unsplash.com/photo-1614495195673-06b2c6d4f44a?w=800&q=80",
  ...
  {
    id: 4,
    name: "Champion Hoodie Streetwear L",
    brand: "Champion",
    category: "bluzy",
    size: "L",
    ...
    salePrice: null,
    condition: "Bardzo dobry",
    tags: ["champion", "hoodie", "streetwear"],
    badge: "new",
    sold: false,
    description: "Klasyczny hoodie Champion z kultowym logo C na piersi. Gruby materiał, bardzo wygodny na co dzień.",
    images: [
      "https://images.unsplash.com/photo-1620799140188-3b2a02fd9a77?w=800&q=80",
      "https://images.unsplash.com/photo-1556821840-3a63f15732ce?w=800&q=80",
    ],
  ...
  },
  {
    ...
    salePrice: 39,
    condition: "Bardzo dobry",
    tags: ["adidas", "y2k", "graphic"],
    badge: null,
    sold: false,
    description: "Koszulka Adidas z dużą grafiką Y2K — estetyka wczesnych 2000s. Luźny krój, bawełna premium.",
    images: [
      "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=800&q=80",
      "https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?w=800&q=80",
    ],
  ...
  {
    id: 6,
    name: "Levi's 501 Kurtka Jeansowa L",
    brand: "Levi's",
    category: "kurtki",
    size: "L",
    ...
    salePrice: null,
    condition: "Dobry",
    tags: ["levis", "jeans", "vintage"],
    badge: null,
    sold: true,
    description: "Kultowa kurtka jeansowa Levi's 501. Mocny denim z lat 90s, naturalne przetarcia nadają charakteru.",
    images: [
  ...
  {
    id: 7,
    name: "Tommy Hilfiger Logo Tee L",
    ...
    badge: null,
    sold: true,
    description: "T-shirt Tommy Hilfiger z ikonicznym logo. Klasyczna bawełna, krój regular.",
    images: [
      "https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?w=800&q=80",
    ],
    vinted_url: "https://www.vinted.pl",
  ...
  {
    id: 8,
    name: "Columbia Softshell Kurtka XL",
    brand: "Columbia",
    category: "kurtki",
    size: "XL",
    style: ["gorpcore", "outdoor"],
    ...
    salePrice: 99,
    condition: "Dobry",
    tags: ["columbia", "outdoor", "gorpcore"],
    badge: "hot",
    sold: false,
    description: "Kurtka softshell Columbia idealna w stylu gorpcore. Wiatroodporna, lekko wodoodporna powłoka.",
    images: [
      "https://images.unsplash.com/photo-1602810316498-ab67cf68c8e1?w=800&q=80",
      "https://images.unsplash.com/photo-1547949003-9792a18a2601?w=800&q=80",
    ],
...
const REVIEWS = [
  ...
  },
  {
    ...
    stars: 4.5,
    comment: "Kurtka TNF przyszła w świetnym stanie, opis był rzetelny. Jedyna rzecz to trochę dłużej czekałem na wysyłkę ale wszystko gra.",
    date: "18.01.2026",
    likes: 7,
  },
  {
    ...
    stars: 5,
    comment: "Najlepsza perełkarnia jaką znam na Vinted! Drugi zakup i znowu ideał. Sweter Ralph Lauren wyglądał nawet lepiej niż na fotce. Na pewno wrócę!",
    date: "20.01.2026",
    likes: 21,
  },
  {
    ...
    stars: 4,
    comment: "Solidnie. Koszulka Adidas w porządnym stanie, cena uczciwa jak na vintage. Opakowanie w punkt.",
    date: "10.01.2026",
    likes: 4,
  },
  {
    ...
    stars: 5,
    comment: "Bardzo miły kontakt, szybka odpowiedź na pytania. Ciuch idealny, szczegóły dokładnie opisane. Super!",
    date: "12.01.2026",
    likes: 9,
  },
];
